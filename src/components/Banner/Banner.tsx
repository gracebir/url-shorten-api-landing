...
function Banner() {
  return (
    <div className='h-screen md:h-[85vh] lg:h-[85vh] flex flex-col gap-10 px-8 lg:flex-row-reverse md:px-0 md:gap-4 lg:justify-between md:items-center md:container md:mx-auto'>
        <div className='md:w-[100vw] md:h-[48vh] lg:h-[60vh] lg:w-[100vw] h-[38vh] mr-[-50%] md:mr-[-35%] lg:mr-[-30%]'>
        <img 
